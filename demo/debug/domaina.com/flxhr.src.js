...
(function(global){
	...
	var win = global,
		...
		//flXHR_vbs = "flXHR.vbs",				// Removed Binary support
		...
		_ONERROR_ = "onerror",
		//_BINARYRESPONSEBODY_ = "binaryResponseBody",	// Remove Binary support
		//_XMLRESPONSETEXT_ = "xmlResponseText",		// Remove XML support
	...
	_flensed.flXHR = function(configObject) {
		...
		function chunkResponse() {
			if (typeof arguments[0] === JSSTR) {	// a single string parameter
		...
		function updatePublicAPI() {
			try {
				...
				//publicAPI.responseXML = responseXML;		// Remove XML support
				//publicAPI.responseBody = responseBody;	// Remove Binary support
				...
				//publicAPI[_BINARYRESPONSEBODY_] = binaryResponseBody;	// Remove Binary support
				//publicAPI[_XMLRESPONSETEXT_] = xmlResponseText;		// Remove XML support
			}
			catch (err) { }
		}
		...
		function reset() {
			...
			statusText = null;
			responseText = null;
			//responseXML = null;	// Remove Binary support
			//responseBody = null;	// Remove XML support
			rawresponse = null;
			_error = JSFALSE;
			updatePublicAPI();
		...
		publicAPI = {
			...
			//responseBody:responseBody,	// Remove Binary support
			responseText:responseText,
			//responseXML:responseXML,		// Remove XML support
			status:status,
			...
			//binaryResponseBody:binaryResponseBody,	// Remove Binary support
			//xmlResponseText:xmlResponseText,			// Remove XML support
			onerror:onerror,
